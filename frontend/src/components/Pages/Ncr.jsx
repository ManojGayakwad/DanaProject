...
const Ncr = () => {
    ...
    const [Ncr, setNcr] = useState({
        ...
        ReworkHrs: "", RCA: "", Resolutionowner: "", ResolutionownerId: "", RCAValidator: "", RCAValidatorId: "", Finalapprover: "", FinalapproverId: "", source: "", Creator: localStorage.getItem("fname") + " " + localStorage.getItem("lname"), CreatorId: localStorage.getItem("username")
    })
    ...
    const handleInputs2 = (e) => {   
        ...
        if (name === "Resolutionowner") {
            name2 = "ResolutionownerId"
            value3 = value2.substring(index + 1, value2.length)
            setNcr({ ...Ncr, [name2]: value3, [name]: value })
        }
        else if (name === "RCAValidator") {
            name2 = "RCAValidatorId"
            value3 = value2.substring(index + 1, value2.length)
            setNcr({ ...Ncr, [name2]: value3, [name]: value })
        }
        else if (name === "Finalapprover") {
            name2 = "FinalapproverId"
            value3 = value2.substring(index + 1, value2.length)
            setNcr({ ...Ncr, [name2]: value3, [name]: value })
        }
    }
